    ...
    <section aria-labelledby="contact-title" className="bg-[#0B2239]">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10 md:gap-16 py-16 md:py-24">
        ...
        <div className="flex-1 min-w-0 max-w-135">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/30 bg-white/10 px-8 py-3 text-base font-semibold text-white transition hover:bg-white/20 w-full sm:w-auto"
            >
        ...
        <div className="flex-1 min-w-0 flex justify-center md:justify-end">
          <div className="relative w-full max-w-105 aspect-4/3 rounded-xl overflow-hidden shadow-lg">
            <Image
