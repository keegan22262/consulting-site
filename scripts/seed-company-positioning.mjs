...
const doc = {
  ...
  mission:
    "At Rill Singh Limited, we deliver comprehensive, innovative solutions designed to drive sustainable growth and transformation for businesses across the globe. Guided by our PRIDE philosophy (Precision, Integrity, Discipline, Execution), we focus on providing results-driven, tailored consulting services for startups, SMEs, and large enterprises. Our goal is to empower entities through strategic transformation, technology integration, financial optimization, and human capital development.",
  brandPositioning:
    "Rill Singh Limited positions itself as a consulting firm that provides the same level of expertise as larger firms, but with a more personalized, flexible, and cost-effective approach. We emphasize niche expertise in areas such as digital transformation, AI consulting, and SME tax advisory to stand out in competitive markets. While aiming for a global reputation, we position ourselves as local experts with global insights, delivering tailored solutions for businesses of all sizes.",
  problemStatement:
    "Many organizations struggle with defining clear strategies or face challenges when translating strategic intent into effective execution. Rapid technological change, regulatory complexity, and organizational inefficiencies further compound these challenges. Rill Singh Limited addresses these issues by delivering expert, cost-effective, and customized solutions that combine strategic clarity with disciplined execution.",
  painPoints: [
