...
const SERVICES = [
  ...
  { title: "Financial Advisory, Audit & Risk", description: "Regulatory compliance, risk assessment, and financial restructuring.", href: "/services/finance", image: "/images/capabilities/financial.jpg" },
  ...
  { title: "Sustainability & ESG", description: "ESG reporting, climate risk assessment, and sustainable practices.", href: "/services/esg", image: "/images/industries/sectors/energy-resources.jpg" },
  { title: "Public Sector Advisory", description: "Policy analysis, public sector reform, and digital government.", href: "/services/public", image: "/images/industries/sectors/public-sector-government.jpg" },
  { title: "Digital Communication", description: "Social media strategy, digital brand management, and content marketing.", href: "/services/comms", image: "/images/industries/sectors/technology-digital.jpg" },
